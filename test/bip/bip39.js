...
describe('BIP39', function () {
  it('128bits entropy without passphrase', function () {
    var entropy = '0c1e24e5917779d297e14d45f14e1a1a'
    var mnemonic = Bip39.mnemonic(entropy)
    assert.strictEqual(mnemonic, 'army van defense carry jealous true garbage claim echo media make crunch')
    var seed = Bip39.seed(entropy)
    ...
    var seedByMnemonic = Bip39.seedByMnemonic('army van defense carry jealous true garbage claim echo media make crunch')
  ...
  it('128bits entropy with passphrase', function () {
    ...
    var mnemonic = Bip39.mnemonic(entropy)
    assert.strictEqual(mnemonic, 'army van defense carry jealous true garbage claim echo media make crunch')
    var seed = Bip39.seed(entropy, 'SuperDuperSecret')
    ...
    var seedByMnemonic = Bip39.seedByMnemonic('army van defense carry jealous true garbage claim echo media make crunch', 'SuperDuperSecret')
  ...
  it('256bits entropy without passphrase', function () {
    var entropy = '2041546864449caff939d32d574753fe684d3c947c3346713dd8423e74abcf8c'
    var mnemonic = Bip39.mnemonic(entropy)
    ...
    var seedByMnemonic = Bip39.seedByMnemonic('cake apple borrow silk endorse fitness top denial coil riot stay wolf luggage oxygen faint major edit measure invite love trap field dilemma oblige')
